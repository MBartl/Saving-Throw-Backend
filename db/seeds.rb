...
#
#   # Create AbilityScore
#   ability_score = AbilityScore.create(character: new, strength: rand(9)+7, dexterity: rand(9)+7, constitution: rand(9)+7, intelligence: rand(9)+7, wisdom: rand(9)+7, charisma: rand(9)+7)
#
#   # Add Hit Points
#   hp = new.hit_points
#   (new.level-1).times do
